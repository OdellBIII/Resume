  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{\textbf{RPCX (OpenResty/Lua):} Co-developed a high-throughput RPC proxy and caching layer handling hundreds of req/s in production (stress-tested to thousands), reducing redundant RPC calls by orders of magnitude and saving thousands of dollars monthly; investigated and remediated failed upstreams to maintain protocol uptime.}
